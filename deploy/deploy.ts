...
//     const contractAddress = "0x029F528c422017930450d59E7701866d2f0470e2";
//     // console.log(`✅ ${artifact.contractName} deployed to => ${contractAddress}`);

//     // // --- Change ownership of the contract --- //
//     // const tx = await (contract as any).transferOwnership(process.env.OWNER_ADDR);
//     // await tx.wait();
//     // console.log(`✅ Ownership of ${artifact.contractName} transferred to ${wallet.address}`);
